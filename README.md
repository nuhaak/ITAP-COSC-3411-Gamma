...
## Key Features
#### Core Arithemtic: Supports standard operations (addition, subtraction, multiplication, division).

#### Instant Execution: Evaluates expressions directly via command-line arguments or an interactive prompt.
